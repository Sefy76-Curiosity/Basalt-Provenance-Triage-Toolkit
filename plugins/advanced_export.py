...
class AdvancedExportPlugin:
    ...
    def _create_export_interface(self):
        ...
        citation_text = (
            ...
            "Levy, S. (2026). Basalt Provenance Triage Toolkit (v11.0).\n"
    ...
    def _export_summary_report(self):
        ...
        try:
            with open(filename, 'w', encoding='utf-8') as f:
                ...
                f.write("Author: Sefy Levy | https://doi.org/10.5281/zenodo.18499129\n")
                f.write("=" * 70 + "\n")
    ...
    def _copy_citation(self):
        ...
        citation = (
            ...
            "Samples (Version 11.0). Zenodo. https://doi.org/10.5281/zenodo.18499129"
        )
