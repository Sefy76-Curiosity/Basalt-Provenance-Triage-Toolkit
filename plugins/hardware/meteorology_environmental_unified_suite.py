...
def setup_plugin(main_app):
    global _METEOROLOGY_REGISTERED
    if _METEOROLOGY_REGISTERED:
        print("⏭️ Meteorology & Environment plugin already registered, skipping...")
        return None
    ...
    if hasattr(main_app, 'menu_bar'):
        ...
        main_app.hardware_menu.add_command(
            label=PLUGIN_INFO.get("name", "Meteorology & Environment"),
            command=plugin.show_interface
        )
